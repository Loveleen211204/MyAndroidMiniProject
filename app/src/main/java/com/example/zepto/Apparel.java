...
public class Apparel extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryList.add(new Category("Men's Bottomwear", R.drawable.men_bottom));
        ...
        categoryList.add(new Category("Bags", R.drawable.bag));
